...
- Press Space to preview selected text, common images, and Quake assets, including BSP, LMP, MDL, PCX, SPR, TGA, and WAD files. Optional Quick Preview checkboxes label major BSP items and objectives.
